...
pub(super) fn default_keybindings_config() -> KeyBindingsConfig {
    KeyBindingsConfig {
        ...
        issue_detail: vec![
            KeyBindingConfig::new(BindingAction::Confirm, "<enter>"),
            KeyBindingConfig::new(BindingAction::Quit, "q"),
            KeyBindingConfig::new(BindingAction::EditIssue, "e"),
            KeyBindingConfig::new(BindingAction::TransitionIssue, "m"),
            KeyBindingConfig::new(BindingAction::AddComment, "C"),
            KeyBindingConfig::new(BindingAction::AssignToMe, "a"),
        ...
        search_issues: vec![
            KeyBindingConfig::new(BindingAction::Confirm, "<enter>"),
            KeyBindingConfig::new(BindingAction::FocusQuery, "/"),
            KeyBindingConfig::new(BindingAction::MoveUp, "k"),
            KeyBindingConfig::new(BindingAction::MoveUp, "<up>"),
            KeyBindingConfig::new(BindingAction::MoveDown, "j"),
            KeyBindingConfig::new(BindingAction::MoveDown, "<down>"),

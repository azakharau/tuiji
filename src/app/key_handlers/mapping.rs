...
pub(super) fn binding_action_to_action_id(action: BindingAction) -> ActionId {
    match action {
        ...
        BindingAction::EditIssue => ActionId::EditIssue,
        BindingAction::TransitionIssue => ActionId::TransitionIssue,
        BindingAction::AddComment => ActionId::AddComment,
        BindingAction::AssignToMe => ActionId::AssignToMe,
        BindingAction::FocusQuery => ActionId::FocusQuery,
